...
public class HttpClientManagerFactoryBen implements FactoryBean<CloseableHttpClient>, InitializingBean, DisposableBean {
	...
	@Qualifier("MyConnectionKeepAliveStrategy")
	@Autowired
	private ConnectionKeepAliveStrategy connectionKeepAliveStrategy;
	@Qualifier("MyHttpRequestRetryHandler")
	@Autowired
	private HttpRequestRetryHandler httpRequestRetryHandler;
	//@Autowired
	//private MyDefaultProxyRoutePlanner proxyRoutePlanner;
	@Qualifier("MyPoolingHttpClientConnectionManager")
	@Autowired
	private PoolingHttpClientConnectionManager poolHttpcConnManager;
	@Qualifier("MyRequestConfig")
	@Autowired
